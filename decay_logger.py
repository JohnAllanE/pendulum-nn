#!/usr/bin/env python3
"""
Experiment 1: Pendulum decays to low amplitude, then is stimulated to high-amplitude oscillation and the cycle repeats
The data generated here is intended to show the decay of the pendulum's oscillation amplitude over time.
...
def main():
    ...
    parser.add_argument("--out", "-o", default="logs/decay/peaks.npz", help="Output file (.npz, .npy or .csv). Default: logs/decay/peaks.npz")
